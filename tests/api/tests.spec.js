...
test.describe('First Real Challenge', () => {
    ...
    test('2. Запрашиваем список challenges',{ tag: ['@challenges', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
...
test.describe('GET Challenges', () => {
    ...
    test('3. Запрашиваем список todos', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
    ...
    test('4. Получаем ошибку, если эндпоинт todo в ед.ч, 404', { tag: ['@todos', '@get', '@negative'],},  async ({ request }) => {
        let api = new Api(request);
        const response = await api.todos.getTodoList();
        expect(response.status()).toBe(404);
    });

    test('5. Запрашиваем todo по id', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
    ...
    test('6. Запрашиваем todo по несуществующему id, 404', { tag: ['@todos', '@get', '@negative'],},  async ({ request }) => {
        let api = new Api(request);
        const todosListResponse = await api.todos.getTodosList();
        const todosListJson = await todosListResponse.json();
        const todosListLength = todosListJson.todos.length;
    ...
    test('7. Запрашиваем список todos с фильтром', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
...
test.describe('HEAD Challenges', () => {
    ...
    test('8. Запрашиваем список хедеров запроса /todos', { tag: ['@todos', '@head', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
        const checkedHeaderName = 'server';
        const checkedHeaderValue = 'Heroku';
...
test.describe('Creation Challenges with POST', () => {
    ...
    test('9. Создаем новое todo', { tag: ['@todos', '@post', '@positive'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
    ...
    test('10. Создаем новое todo c невалидным doneStatus, 400', { tag: ['@todos', '@post', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addInvalidStatus()
            .addDescription()
    ...
    test('11. Создаем новое todo cо слишком длинным title, 400', { tag: ['@todos', '@post', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTooLongTitle(51)
            .addStatus()
            .addDescription()
    ...
    test('12. Создаем новое todo cо слишком длинным description, 400', { tag: ['@todos', '@post', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
    ...
    test('13. Создаем новое todo с максимально возможными title и description', { tag: ['@todos', '@post', '@positive'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTooLongTitle(50)
            .addStatus()
    ...
    test('14. Создаем новое todo cо слишком объемным payload в поле description, 413', { tag: ['@todos', '@post', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
    ...
    test('15. Создаем новое todo c несуществующим полем, 400', { tag: ['@todos', '@post', '@negative'],}, async ({ request }) => {
...
test.describe('Creation Challenges with PUT', () => {
    ...
    test('16. Обновляем несуществующий todo запросом PUT, 400', { tag: ['@todos', '@put', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
...
test.describe('Update Challenges with POST', () => {
    ...
    test('17. Обновляем существующий todo запросом POST', { tag: ['@todos', '@post', '@positive'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
    ...
    test('18. Проверяем, что нельзя обновить несуществующий todo запросом POST', { tag: ['@todos', '@post', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
...
test.describe('Update Challenges with PUT', () => {
    ...
    test('19. Обновляем todo запросом PUT', { tag: ['@todos', '@put', '@positive'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
    ...
    test('20. Обновляем title существующего todo запросом PUT', { tag: ['@todos', '@put', '@positive'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
    ...
    test('21. Обновляем todo запросом PUT без поля title, 400', { tag: ['@todos', '@put', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
    ...
    test('22. Обновляем todoId запросом PUT, 400', { tag: ['@todos', '@put', '@negative'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
...
test.describe('DELETE Challenges', () => {
    ...
    test('23. Удаляем todo по id', { tag: ['@todos', '@delete', '@positive'],}, async ({ request }) => {
        const randomTodo = new TodoBuilder()
            .addTitle()
            .addStatus()
            .addDescription()
...
test.describe('OPTIONS Challenges', () => {
    ...
    test('24. Проверяем варианты типов запросов /todos', { tag: ['@todos', '@options', '@positive'],}, async ({ request }) => {
        const allowListMethods = 'OPTIONS, GET, HEAD, POST';
        let api = new Api(request);
...
test.describe('Accept Challenges', () => {
    ...
    test('25. Проверяем, что список todos может возвращаться в XML-формате', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
    ...
    test('26. Проверяем, что список todos может возвращаться в JSON-формате', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
    ...
    test('27. Проверяем, что список todos возвращается по умолчанию в JSON-формате', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
        const acceptHeader = '*/*';
    ...
    test('28. Проверяем, что список todos при наличии в хедере обоих форматов JSON и XML возвращается в XML', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
    ...
    test('29. Проверяем, что список todos возвращается без хедера Accept', { tag: ['@todos', '@get', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
        const acceptHeader = '';
        const acceptHeaderJson = 'application/json';
        const response = await api.todos.getTodosAccept(acceptHeader);
    ...
    test('30. Проверяем, что возвращается ошибка 406 при невалидном значении Accept', { tag: ['@todos', '@get', '@negative'],}, async ({ request }) => {
        let api = new Api(request);
...
test.describe('Fancy a break? Restore your session', () => {
    ...
    test('34. Возвращаем прогресс выполнения заданий по guid', { tag: ['@challenger', '@get', '@positive'],}, async ({ request }) => {
    ...
    test('35. Обновляем прогресс выполнения заданий по guid', { tag: ['@challenger', '@put', '@positive'],}, async ({ request }) => {
        const guid = process.env['AUTH_TOKEN'];
        let api = new Api(request);
    ...
    test('36. Обновляем прогресс выполнения заданий для guid не из БД', { tag: ['@challenger', '@put', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
        const guid = process.env['AUTH_TOKEN'];
        const responseProgress = await api.challenger.getProgress(guid);
        expect(responseProgress.status()).toBe(200);
    ...
    test('37. Возвращаем список todo по guid', { tag: ['@challenger', '@get', '@positive'],}, async ({ request }) => {
        const guid = process.env['AUTH_TOKEN'];
        let api = new Api(request);
    ...
    test('38. Обновляем список todo по guid', { tag: ['@challenger', '@put', '@positive'],}, async ({ request }) => {
        const guid = process.env['AUTH_TOKEN'];
        let api = new Api(request);
        //Cоздаем newGuid
...
test.describe('Status Code Challenges', () => {
    ...
    test('41. Пытаемся использовать недопустимый метод DELETE для /heartbeat', { tag: ['@heartbeat', '@delete', '@negative'],}, async ({ request }) => {
        let api = new Api(request);
        const response = await api.heartbeat.delete();
        expect(response.status()).toBe(405);
    });

    test('42. Пытаемся использовать недопустимый метод PATCH для /heartbeat', { tag: ['@heartbeat', '@patch', '@negative'],}, async ({ request }) => {
        let api = new Api(request);
        const response = await api.heartbeat.patch();
        expect(response.status()).toBe(500);
    });

    test('43. Пытаемся использовать недопустимый метод TRACE для /heartbeat', { tag: ['@heartbeat', '@trace', '@negative'],}, async ({ request }) => {
        let api = new Api(request);
        const response = await api.heartbeat.trace();
        expect(response.status()).toBe(501);
    });

    test('44. Получаем статус соединения методом GET /heartbeat', { tag: ['@heartbeat', '@get', '@positive'],}, async ({ request }) => {
        const server = 'Heroku';
        const via = '1.1 heroku-router';
        let api = new Api(request);
...
test.describe('HTTP Method Override Challenges', () => {
    ...
    test('45. Пытаемся использовать недопустимый метод DELETE в хедерах метода POST /heartbeat', { tag: ['@heartbeat', '@post', '@negative'],}, async ({ request }) => {
        let api = new Api(request);
        const method = 'DELETE';
    ...
    test('46. Пытаемся использовать недопустимый метод PATCH в хедерах метода POST /heartbeat', { tag: ['@heartbeat', '@post', '@negative'],}, async ({ request }) => {
        let api = new Api(request);
        const method = 'PATCH';
        const response = await api.heartbeat.postOverride(method);
        expect(response.status()).toBe(500);
    ...
    test('47. Пытаемся использовать недопустимый метод TRACE в хедерах метода POST /heartbeat', { tag: ['@heartbeat', '@post', '@negative'],}, async ({ request }) => {
        let api = new Api(request);
        const method = 'TRACE';
        const response = await api.heartbeat.postOverride(method);
        expect(response.status()).toBe(501);
...
test.describe('Authentication Challenges', () => {
    ...
    test('48. Пытаемся получить authtoken с неверными кредами через POST /secret/token', { tag: ['@secret', '@post', '@negative'],}, async ({ request }) => {
    ...
    test('49. Пытаемся получить authtoken с корректными кредами через POST /secret/token', { tag: ['@secret', '@post', '@positive'],}, async ({ request }) => {
        let api = new Api(request);
...
test.describe('Authorization Challenges', () => {
    ...
    test('50. Пытаемся получить notes с неверным authtoken через GET /secret/note', { tag: ['@secret', '@get', '@negative'],}, async ({ request }) => {
        const authToken = 'invalidAuth';
        let api = new Api(request);
        const response = await api.secret.getNote(authToken);
        expect(response.status()).toBe(403);
    });

    test('51. Пытаемся получить notes без authtoken через GET /secret/note', { tag: ['@secret', '@get', '@negative'],}, async ({ request }) => {
